...
Moodle Telegram Integration is catalogued as part of the e-Learning UMT internal and customized application ecosystem.

Moodle integration customized with webhook support, custom message parameters, and additional language updates.

## Classification

- **Category:** Customized Payment, Messaging, and Event Integrations
...
This application documentation page centralizes the operational reference for Moodle Telegram Integration. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
2. Check whether the issue is isolated to Moodle Telegram Integration or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.

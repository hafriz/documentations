...
External Backup and Restore Courses is catalogued as part of the e-Learning UMT internal and customized application ecosystem.

Moodle block or workflow support tool for managing external course backup and restore operations.

## Classification

- **Category:** Customized Moodle Learning and Administration Extensions
...
This application documentation page centralizes the operational reference for External Backup and Restore Courses. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
2. Check whether the issue is isolated to External Backup and Restore Courses or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.

...
QuizGuardian Proctor Plugin Template is catalogued as part of the e-Learning UMT internal and customized application ecosystem.

Moodle plugin template for integrating QuizGuardian-style proctoring workflows into online assessments.

## Classification

- **Category:** Customized Assessment, Quiz, and Academic Integrity Tools
- **Application type:** Moodle extension or Moodle-adjacent service
- **Primary platform:** [epembelajaran.umt.edu.my](https://epembelajaran.umt.edu.my)
- **Documentation owner:** e-Learning UMT
- **Support contact:** [el@umt.edu.my](mailto:el@umt.edu.my)

## Purpose

This application documentation page centralizes the operational reference for QuizGuardian Proctor Plugin Template. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
1. Verify the reported issue, affected user, affected course or record, browser/device details, and exact time of occurrence.
2. Check whether the issue is isolated to QuizGuardian Proctor Plugin Template or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.
3. Review application logs, scheduled tasks, queue workers, cron jobs, web server logs, and integration logs where relevant.
4. Apply the standard support workflow: reproduce, capture evidence, identify scope, apply fix or workaround, validate with the requester, and document the resolution.
5. Escalate unresolved incidents to the responsible technical owner with screenshots, timestamps, user IDs, course IDs, transaction IDs, or relevant request references.
...
- [Internal and Customized Applications Catalogue](../applications.md)

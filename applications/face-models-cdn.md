...
Face Models CDN is catalogued as part of the e-Learning UMT internal and customized application ecosystem.

Internal support asset for hosting or delivering face model files used by face-recognition or identity-related workflows.

## Classification

- **Category:** Media, Model, and Utility Assets
- **Application type:** Support asset or utility
...
This application documentation page centralizes the operational reference for Face Models CDN. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
2. Check whether the issue is isolated to Face Models CDN or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.

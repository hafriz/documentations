# Atto HTML Bootstrap Editor

## Overview

Atto HTML Bootstrap Editor is catalogued as part of the e-Learning UMT internal and customized application ecosystem.

Moodle Atto editor plugin for creating Bootstrap-based HTML layouts.
...
This application documentation page centralizes the operational reference for Atto HTML Bootstrap Editor. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
2. Check whether the issue is isolated to Atto HTML Bootstrap Editor or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.

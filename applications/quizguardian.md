...
quizguardian is catalogued as part of the e-Learning UMT internal and customized application ecosystem.
...
- **Category:** Private / Internal Laravel and Web Applications
- **Application type:** Laravel or web application
- **Primary URL:** [exam.epembelajaran.umt.edu.my](https://exam.epembelajaran.umt.edu.my)
- **Documentation owner:** e-Learning UMT
- **Support contact:** [el@umt.edu.my](mailto:el@umt.edu.my)

## Purpose

This application documentation page centralizes the operational reference for quizguardian. Use it to keep institutional context, ownership, access notes, support workflows, and maintenance reminders in one consistent location.
...
2. Check whether the issue is isolated to quizguardian or also affects connected Moodle, Laravel, database, storage, authentication, payment, messaging, or webhook services.
